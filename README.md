...
---|---|---|---|---|---|---|---|---
source|0.751100	|0.751777	|0.751100	|0.750558	|640	|640	|100.00%
...
ip1的参数矩阵的最大奇异值为3.354, 最小的奇异值为2.059, 两者相差也不大.
当对ip1进行压缩时, 得到以下结果:  
r	|accuracy	|mean precision	|mean recall	|mean F		|time complexity	|space complexity|compression rate
---|---|---|---|---|---|---|---|---
source|	0.751100|	0.751777|	0.751100|	0.750558|	65536|	65536|	100.00%
