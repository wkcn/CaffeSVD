...
压缩率越小, 代表压缩后的存储空间越小.
r	|accuracy	|mean precision	|mean recall	|mean F		|time complexity	|space complexity|compression rate
---|---|---|---|---|---|---|---|---
...
由于被压缩的全连接网络层ip2的参数矩阵大小为10x64, 矩阵占用的存储空间很小, 被SVD方法压缩后容易出现欠拟合的现象, 导致准确度降低, 比较难体现出参数矩阵被压缩的优势.
...
- 压缩全连接层ip1
我也尝试了保持全连接层ip2不变, 对全连接层ip1(64x1024)进行SVD分解, 
...
当只对ip1进行SVD压缩时, 压缩率为74.71%时, 准确度为0.696. 时间,空间复杂度减少了64 x 1024 x (100% - 74.71%) = 16574
而只对ip2进行SVD压缩时, 压缩率为92.50%时, 准确度为0.690. 时间,空间复杂度减少了10 x 64 x (100% - 92.50%) = 48
...
8(调整)|0.718500|0.718348|0.718500|0.716231	|592	|592	|92.50%
6(调整)|0.706700| 0.714326|0.706700|0.705410|444	|444	|69.38%
10(未调)	|0.751100	|0.751777|0.751100|0.750558	|740	|740	|115.62%
9(未调)	|0.716000	|0.709909|0.716000|0.696003	|666	|666	|104.06%
8(未调)	|0.690300	|0.683415|0.690300|0.672081	|592	|592	|92.50%
7(未调)|0.666800	|0.663032|0.666800|0.637553	|518	|518	|80.94%
6(未调)|0.613200	|0.607457|0.613200|0.580367	|444	|444	|69.38%
